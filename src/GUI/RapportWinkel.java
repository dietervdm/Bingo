...
public class RapportWinkel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelWinkel = new javax.swing.JTable(t);
        ...
        tabelWinkel.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tabelWinkel);
    ...
    private void knopPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_knopPrintActionPerformed
        ...
        try
        {
            tabelWinkel.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        }
    ...
    private javax.swing.JTable tabelWinkel;
