...
public class ToevoegenVestiging extends javax.swing.JFrame {
    
    public JFrame myCaller;
    
    public ToevoegenVestiging() {
        initComponents();
    }
    
    public ToevoegenVestiging(JFrame caller) {
        initComponents();
        myCaller = caller;
    }
    ...
    private void initComponents() {
        ...
        MenuknopToevoegenProduct.setText("Product");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ToevoegenVestiging.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ToevoegenVestiging().setVisible(true);
            }
        });
    }
